...
<table>
    <tr>
          ...
          <th>BLOOD SUGAR LEVEL(Before food) (mg/dL)</th>
 		  <th>BLOOD SUGAR LEVEL(After food) (mg/dL)</th>
    ...
    if(isset($_POST['submit']))
     {
      $userid=$_POST['userid'];
	  $query="SELECT * FROM bloodsugar where userid='$userid'";
...
<tr>
    ...
    <td> <?php echo $row['before_food']; ?> </td>
    <td> <?php echo $row['after_food']; ?> </td>
